...
| `examples/impact_brief.json` | json | 0 | `dd70eda12bdf42e3` | Inspect deterministic fixture output. |
| `examples/impact_brief.md` | markdown | 0 | `90188731ad7ded16` | Inspect deterministic fixture output. |
| `examples/impact_dashboard.json` | json | 0 | `15b20ffab5185a0a` | Inspect deterministic fixture output. |
| `examples/impact_dashboard.md` | markdown | 0 | `2408f81c9d53b684` | Inspect deterministic fixture output. |
...
| `examples/quickstart_receipt.json` | json | 0 | `003fc5f22962a828` | Capture reproducible local-demo commands, hashes, and finance safety boundaries. |
| `examples/quickstart_receipt.md` | markdown | 0 | `89d2253c1e3f370d` | Capture reproducible local-demo commands, hashes, and finance safety boundaries. |
| `examples/impact_artifact_receipt.json` | json | 0 | `a40bbcb39a7019dc` | Inspect deterministic fixture output. |
| `examples/impact_artifact_receipt.md` | markdown | 0 | `03725b56be7b183a` | Inspect deterministic fixture output. |
| `examples/impact_capture_checklist.json` | json | 0 | `48b2ec8a1071e440` | Inspect deterministic fixture output. |
| `examples/impact_capture_checklist.md` | markdown | 0 | `af0246459ea613dc` | Inspect deterministic fixture output. |
| `examples/impact_receipt_compare.json` | json | 0 | `500e8333adb23245` | Inspect deterministic fixture output. |
| `examples/impact_receipt_compare.md` | markdown | 0 | `02069c43399fc7eb` | Inspect deterministic fixture output. |
...
| `examples/taxonomy.json` | json | 0 | `208ab5323753e17f` | Inspect deterministic fixture output. |
| `examples/taxonomy.md` | markdown | 0 | `a0314ba5942d0830` | Inspect deterministic fixture output. |
| `examples/version_report.json` | json | 0 | `e2f9180a4b4f9d30` | Inspect package version, command and fixture counts, release status, and local git refs. |
| `examples/version_report.md` | markdown | 0 | `527d3d531c0a6af1` | Inspect package version, command and fixture counts, release status, and local git refs. |
...
| `examples/impact_compare.json` | json | 0 | `7cabbf2036d42d7c` | Inspect deterministic fixture output. |
| `examples/impact_compare.md` | markdown | 0 | `3bcad5d758aecf1c` | Inspect deterministic fixture output. |
...
| `examples/visual_evidence_receipt.json` | json | 0 | `10e0f531001f5594` | Inspect deterministic fixture output. |
| `examples/visual_evidence_receipt.md` | markdown | 0 | `4ac2e273648a5366` | Inspect deterministic fixture output. |
| `examples/finalize_release.json` | json | 0 | `462ce58187b6eff5` | Review one deterministic release checklist before handoff. |
| `examples/finalize_release.md` | markdown | 0 | `55817801ea091150` | Review one deterministic release checklist before handoff. |
...
### `examples/impact_brief.json`

- Command: `python -m market_catalyst_calendar impact-brief --input examples/demo_records.json --as-of 2026-05-13 --days 45 --format json`
- Output type: `json`
- Bytes: 4933
- SHA-256: `dd70eda12bdf42e33a1083b96b7b3848b25d312c1731b866bbbd57eed713607f`
- Input fixtures: `examples/demo_records.json`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.

### `examples/impact_brief.md`

- Command: `python -m market_catalyst_calendar impact-brief --input examples/demo_records.json --as-of 2026-05-13 --days 45`
- Output type: `markdown`
- Bytes: 3522
- SHA-256: `90188731ad7ded160244fb18a7dca8dded8c119df87a8455532ad8f1bf3618f6`
- Input fixtures: `examples/demo_records.json`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.

### `examples/impact_dashboard.json`

- Command: `python -m market_catalyst_calendar impact-dashboard --input examples/demo_records.json --as-of 2026-05-13 --days 45 --format json`
- Output type: `json`
- Bytes: 3625
- SHA-256: `15b20ffab5185a0a581467630fdca920fc81ee4bef28a5444442caa4c38d25b0`
- Input fixtures: `examples/demo_records.json`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.

### `examples/impact_dashboard.md`

- Command: `python -m market_catalyst_calendar impact-dashboard --input examples/demo_records.json --as-of 2026-05-13 --days 45`
- Output type: `markdown`
- Bytes: 1354
- SHA-256: `2408f81c9d53b684313c49215357132b0e506abc9c0295df5ed48454b6b5ad58`
- Input fixtures: `examples/demo_records.json`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.
...
### `examples/quickstart_receipt.json`

- Command: `python -m market_catalyst_calendar quickstart-receipt --input examples/demo_records.json --as-of 2026-05-13 --days 45`
- Output type: `json`
- Bytes: 4098
- SHA-256: `003fc5f22962a82897f2755f9d3d15dec26ea65ef2047bf5b5c2a5fa868df61c`
- Input fixtures: `examples/demo_records.json`
- Recommended use cases:
...
### `examples/quickstart_receipt.md`

- Command: `python -m market_catalyst_calendar quickstart-receipt --input examples/demo_records.json --as-of 2026-05-13 --days 45 --format markdown`
- Output type: `markdown`
- Bytes: 3252
- SHA-256: `89d2253c1e3f370d74bc0ebd6ea97b6a43ba84abc43b34cdc70d4811439b3c62`
- Input fixtures: `examples/demo_records.json`
- Recommended use cases:
  - Capture reproducible local-demo commands, hashes, and finance safety boundaries.
  - Use as a quickstart receipt before handing off deterministic examples.
...
- Command: `python -m market_catalyst_calendar impact-artifact-receipt --root .`
- Output type: `json`
- Bytes: 5479
- SHA-256: `a40bbcb39a7019dcbaf15971d01c1e0f489cacc3e72f68295961203378780fa9`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.

### `examples/impact_artifact_receipt.md`

- Command: `python -m market_catalyst_calendar impact-artifact-receipt --root . --format markdown`
- Output type: `markdown`
- Bytes: 2886
- SHA-256: `03725b56be7b183a861970c86692905d5bcc53b8e0002205a248e37d955eed76`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.

### `examples/impact_capture_checklist.json`

- Command: `python -m market_catalyst_calendar impact-capture-checklist --root .`
- Output type: `json`
- Bytes: 6358
- SHA-256: `48b2ec8a1071e440a96eff1eef07bef4130ab223b5e4ba40df072e25e8afbbcd`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.

### `examples/impact_capture_checklist.md`

- Command: `python -m market_catalyst_calendar impact-capture-checklist --root . --format markdown`
- Output type: `markdown`
- Bytes: 2717
- SHA-256: `af0246459ea613dc1eb600a911cd2c62310476a20f18783abcf8316afbfaed51`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.

### `examples/impact_receipt_compare.json`

- Command: `python -m market_catalyst_calendar impact-receipt-compare --base examples/impact_artifact_receipt.json --current examples/impact_artifact_receipt.json`
- Output type: `json`
- Bytes: 4904
- SHA-256: `500e8333adb23245db830e1c4ebac81e827e7d8576678ea8a2ebd15853850cfe`
- Input fixtures: `examples/impact_artifact_receipt.json`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.

### `examples/impact_receipt_compare.md`

- Command: `python -m market_catalyst_calendar impact-receipt-compare --base examples/impact_artifact_receipt.json --current examples/impact_artifact_receipt.json --format markdown`
- Output type: `markdown`
- Bytes: 2795
- SHA-256: `02069c43399fc7eb792bacd209d50aba1c77ac0ba812ef6809f4006673bf7fcc`
- Input fixtures: `examples/impact_artifact_receipt.json`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.
...
- Output type: `json`
- Bytes: 22270
- SHA-256: `208ab5323753e17f1f939ce31536a964fa014a74da5a151d0fa66a910f383d22`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.
...
- Output type: `markdown`
- Bytes: 7925
- SHA-256: `a0314ba5942d0830f0b3ccc40dfa3ec20ca92187d607da5f30ef7875372209b9`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.
...
- Output type: `json`
- Bytes: 942
- SHA-256: `e2f9180a4b4f9d302d1b9ab993ffe619cdea99c52eb9c3dedc6fb63c6d3a2d55`
- Recommended use cases:
...
- Output type: `markdown`
- Bytes: 275
- SHA-256: `527d3d531c0a6af1ef47d763cb4009367290c5eb10912afddfd813ead81f9ae6`
- Recommended use cases:
  - Inspect package version, command and fixture counts, release status, and local git refs.
  - Use as a compact release handoff snapshot before tagging.
...
### `examples/impact_compare.json`

- Command: `python -m market_catalyst_calendar impact-compare --base examples/demo_records.json --current examples/demo_records_updated.json --as-of 2026-05-27`
- Output type: `json`
- Bytes: 3897
- SHA-256: `7cabbf2036d42d7c2014de013af356d5fbaa03291d13c9c8367c83b3d2df3a96`
- Input fixtures: `examples/demo_records.json`, `examples/demo_records_updated.json`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.

### `examples/impact_compare.md`

- Command: `python -m market_catalyst_calendar impact-compare --base examples/demo_records.json --current examples/demo_records_updated.json --as-of 2026-05-27 --format markdown`
- Output type: `markdown`
- Bytes: 1990
- SHA-256: `3bcad5d758aecf1c8dacd64ef58549c2039bc92a5ce8a047ffb188b3467d1a26`
- Input fixtures: `examples/demo_records.json`, `examples/demo_records_updated.json`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.
...
### `examples/visual_evidence_receipt.json`

- Command: `python -m market_catalyst_calendar visual-evidence-receipt --root .`
- Output type: `json`
- Bytes: 3525
- SHA-256: `10e0f531001f5594685e2bb0576ed66f869190b81d430ff7b2509fc257663520`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.

### `examples/visual_evidence_receipt.md`

- Command: `python -m market_catalyst_calendar visual-evidence-receipt --root . --format markdown`
- Output type: `markdown`
- Bytes: 2704
- SHA-256: `4ac2e273648a536690f813ab7a72ade282fde1c816a4909aa8748d2657c53d08`
- Recommended use cases:
  - Inspect deterministic fixture output.
  - Use as a stable regression fixture for downstream tooling.
...
- Output type: `json`
- Bytes: 1831
- SHA-256: `462ce58187b6eff5428a3602bb08ec9b6e2c0eee73297dde700bde7b3b199388`
- Recommended use cases:
...
- Output type: `markdown`
- Bytes: 615
- SHA-256: `55817801ea091150c9de8f16bcbfdd5c967b33b7f56b47d449ca003811494ec7`
- Recommended use cases:
  - Review one deterministic release checklist before handoff.
  - Combine audit, smoke, fixture, and changelog status for release notes.
