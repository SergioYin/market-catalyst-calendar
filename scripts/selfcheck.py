...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        comparisons = [
            ...
            (
                [sys.executable, "-m", "market_catalyst_calendar", "broker-matrix", "--input", str(demo_path), "--as-of", "2026-05-13"],
                ROOT / "examples" / "broker_matrix.json",
            ),
            (
                [
                    sys.executable,
                ...
                ROOT / "examples" / "broker_matrix.md",
            ),
            (
                [sys.executable, "-m", "market_catalyst_calendar", "watchlist", "--input", str(demo_path), "--as-of", "2026-05-13", "--days", "45"],
                ROOT / "examples" / "watchlist.json",
            ),
            (
                [
                    sys.executable,
                ...
                ROOT / "examples" / "watchlist.md",
            ),
            (
                [sys.executable, "-m", "market_catalyst_calendar", "html-dashboard", "--input", str(demo_path), "--as-of", "2026-05-13", "--days", "45"],
                ROOT / "examples" / "dashboard.html",
            ),
            (
