...
- The workflow uses only supplied dataset fixtures and explicitly excludes live data, broker connectivity, predictions, investment advice, and trade recommendations.
