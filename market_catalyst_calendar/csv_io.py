...
def _record_to_row(as_of: str, record: CatalystRecord) -> Dict[str, str]:
    return {
        ...
        "risk_budget": _format_optional_number(record.risk_budget),
        "max_loss": _format_optional_number(record.max_loss),
...
def _row_to_record(row: Dict[str, str], row_number: int) -> Dict[str, object]:
    ...
    record: Dict[str, object] = {
        ...
        "risk_budget": _parse_optional_float(row.get("risk_budget", ""), row_number, "risk_budget"),
        "max_loss": _parse_optional_float(row.get("max_loss", ""), row_number, "max_loss"),
        "sector": _optional_cell(row, "sector"),
        "theme": _optional_cell(row, "theme"),
