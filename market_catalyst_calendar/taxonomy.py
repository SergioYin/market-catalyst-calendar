...
COMMAND_CATALOG = [
    ...
    {"id": "impact-dashboard", "category": "briefing", "formats": ["json", "markdown"], "inputs": ["dataset", "impact brief"], "purpose": "summarize static impact brief dashboard panels", "writes_files": False},
    ...
    {"id": "visual-evidence-receipt", "category": "operations", "formats": ["json", "markdown"], "inputs": ["repo examples"], "purpose": "emit static visual/demo artifact hashes, routes, regeneration commands, capture commands, and public boundaries", "writes_files": True},
    {"id": "impact-receipt-compare", "category": "operations", "formats": ["json", "markdown"], "inputs": ["impact artifact receipts"], "purpose": "compare impact artifact receipt hashes and boundaries across releases", "writes_files": True},
